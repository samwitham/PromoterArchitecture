...
try:
    import class_customtranslator_qpcrs_all_tbfss
except ModuleNotFoundError:
    from src.TRAMP import class_customtranslator_qpcrs_all_tbfss
...
def make_plot(
    ...
    def make_graphic_record(
        ...
        graphic_record = (
            class_customtranslator_qpcrs_all_tbfss.MyCustomTranslator(
                features_properties=(
                    lambda f: {
    ...
    if openchromatin is True:
        ...
        colour_dict = class_customtranslator_qpcrs_all_tbfss.colour_dict
        colour_dict_sorted = {
            k: v
