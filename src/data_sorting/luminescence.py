...
input_fluc = f'../../data/luminescence/to_be_sorted/{date}/leafplate_arabidopsis_fluc.csv'
input_nluc = f'../../data/luminescence/to_be_sorted/{date}/leafplate_arabidopsis_nluc.csv'
