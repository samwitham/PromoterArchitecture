...
def mas5Stats (expressionSet, mas5calls):
    ...
    for full_probe_id, exp_value_dict in expressionSet.items():
        ...
        if prop_present >= 0 and not probe_id.startswith('AFFX'):
...
def main (raw_expr, mas5_pres, ara_annot, araport_houskeeeping, output_directory, file_names):
...
if __name__ == "__main__":
    ...
    main(args.raw_expression_in, args.mas5_presence, args.annotation, args.housekeeping_set,  args.out_dir, args.file_names)
