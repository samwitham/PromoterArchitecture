...
parser.add_argument('Schmid_rankedtau', type=str, help='Input location of ranked tau dataset using Schmid et al 2005 gene expression data')
...
parser.add_argument('Schmid_gene_categories', type=str, help='Output location of microarray tau gene category subsets')
...
def filter_genes_schmid(promoter_bed, select_genes_file):
    ...
    #save df
    filtered_df.to_csv(args.Schmid_allgenes,sep='\t',columns=filtered_df.columns, index=False)
