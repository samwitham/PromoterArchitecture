...
def parse_args(args):
    ...
    parser.add_argument(
        "five_UTR", type=str, help="Output location of the 5UTR bedfile"
    )
    parser.add_argument(
        "five_UTR_swapped_strands",
        type=str,
        help="Output location of the 5UTR bedfile with artificially switched strands for sliding window analysis",
    )
    parser.add_argument(
        "genes_no_5UTR",
        type=str,
        help="Output location of genes which have no 5UTR",
    )
...
def make_5UTRs(
    ...
    no_5UTR = merged[
        (merged.start == merged.start_promoters)
        & (merged.stop == merged.stop_promoters)
    ]
    # filter columns
    no_5UTR = no_5UTR[
        [
