...
parser.add_argument('geneIDtable', type=str, help='location of geneIDtable')
parser.add_argument('motifs_csv', type=str, help='location of motifs_csv output from CiiiDER output')
parser.add_argument('output_tsv', type=str, help='Output location of tsv file containing significantly enriched motifs with AGI and TF family name')
