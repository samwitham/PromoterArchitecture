...
parser.add_argument('all_genes', type=str, help='Input location of Czechowski et al 2005 microarray all genes data')
...
def flagTFs(genes_of_interest, TF_list, all_genes, output):
    ...
    TFs_of_interest = TFs_of_interest[['Gene_ID', 'gene_type','Family','tau']]
