...
def parse_args(args):
    ...
    parser.add_argument(
        "all_genes_ranking",
        type=str,
        help="Input location of all genes ranking",
    )
    parser.add_argument(
        "mapped_motif_bed",
        type=str,
...
def main(args):
    ...
    Czechowski_merged, Czechowski_unique_TF = map_tau(
        args.all_genes_ranking,
    ...
    Czechowski_genetypes = merge_genetype(
        Czechowski_unique_TF, args.gene_categories
    )
    ...
    Czechowski_means_sd_genetype = Czechowski_means_sd_genetype[
        Czechowski_means_sd_genetype.mean_tau.notnull()
    ]
    ...
    print(
        len(
            Czechowski_means_sd_genetype[
                Czechowski_means_sd_genetype.gene_type == args.variable1_name
            ]
        )
    )
    ...
    print(
        len(
            Czechowski_means_sd_genetype[
                Czechowski_means_sd_genetype.gene_type == args.variable2_name
            ]
        )
    )
    ...
    print(
        len(
            Czechowski_means_sd_genetype[
                Czechowski_means_sd_genetype.gene_type == "control"
            ]
        )
    )
