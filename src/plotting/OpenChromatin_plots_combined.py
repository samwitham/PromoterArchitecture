...
def make_plot(
    ...
    def equalise_samples_sizes(
        ...
        with open(
            f"../../data/output/{file_names}/{dependent_variable}/{output_folder_name_promoter}{output_folder_name}plots/number_of_genes_in_each_category_{categorisation_name}_{dependent_variable}.txt",
            "w",
        ) as file:
            file.write(
        ...
        # save sample size as file
        with open(
            f"../../data/output/{file_names}/{dependent_variable}/{output_folder_name_promoter}{output_folder_name}plots/{dependent_variable}_descriptivestats_{categorisation_name}.txt",
            "w",
        ) as file:
...
def main(args):
    ...
    cats_cv = merge_genecategories(chromatin_coverage, args.cv_gene_categories)
    cats_tau = merge_genecategories(
        chromatin_coverage, args.tau_gene_categories
    )
