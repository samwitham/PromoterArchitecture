...
def calculate_shannon_diversity(mapped_motif_bed):
    ...
    missing_names = no_motifs[
        ~no_motifs.promoter_AGI.isin(diversity_df.promoter_AGI)
    ].promoter_AGI.unique()
    # turn into df
...
def main(args):
    ...
    shannon_Czechowski_gene_categories = merge_shannon_genetype(
        shannon_df, args.Czechowski_gene_categories
    )
    ...
    make_plot(
        ...
        "Gene type",
        "TF Shannon diversity",
        f"{args.author_name}_TF_diversity",
        "box",
        args.palette,
        args.file_names,
        dependent_variable,
    ...
    make_plot(
        ...
        "Gene type",
        "TF family Shannon diversity",
        f"{args.author_name}_TF_family_diversity",
        "box",
        args.palette,
        args.file_names,
        dependent_variable,
    ...
    make_plot(
        ...
        "Gene type",
        "TF family count",
        f"{args.author_name}_TF_family_count",
        "box",
        args.palette,
        args.file_names,
        dependent_variable,
    ...
    PCA_df, pca_variance = run_PCA(
        args.mapped_motif_bed, shannon_Czechowski_gene_categories
    )
    # Run hierarchical clustering
    x, z = hierarchical_clustering(
        PCA_df, args.file_names, args.output_folder_name
    )
    # decide how many clusters there are
    # try elbow method
    k = elbow_method(z)
