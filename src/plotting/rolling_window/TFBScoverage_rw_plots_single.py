...
def windows_coords(
    ...
    # save figure
    plt.savefig(
        f"../../data/output/{args.file_names}/rolling_window/{args.foldername_prefix}/plots/{output_prefix}_{variable_of_interest}_{estimator}_sliding_window.pdf",
        format="pdf",
    )
    # remove plot
    plt.clf()
...
coverage_prom_types = add_genetype(
    coverage_df, args.Czechowski_gene_categories
)
