...
def hierarchical_clustering(PCA_df):
    ...
    plt.savefig(f"../../data/output/{args.file_names}/TF_diversity/plots/hierarchical_clustering_TF_family_counts.pdf")
    #linkage matrix
...
def plot_kmeans_clusters(k,PCA_df, pca_variance):
    ...
    fig.savefig(f"../../data/output/{args.file_names}/TF_diversity/plots/PCA_Kmeans_TF_family_counts.pdf")
