...
promoter_fasta=../../data/FIMO/responsivepromoters_TATA.fasta
...
#create bed file from fasta file
...
../meme_suite/./FIMO.sh ../../data/FIMO/${promoterpref}.fasta 0.0001 5000000 ../../data/FIMO/motif_data/plant_pan/TATA_AT1G55520.meme
